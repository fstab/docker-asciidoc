...
Example: If you want to convert a manpage document _~/my-file.txt_ into a Unix manpage using asciidoc's [a2x](ttp://www.methods.co.nz/asciidoc/chunked/ch24.html) command, you can run
